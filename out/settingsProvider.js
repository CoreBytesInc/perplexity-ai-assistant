...
exports.PerplexitySettingsProvider = void 0;
const vscode = __importStar(require("vscode"));
class PerplexitySettingsProvider {
    _extensionUri;
    _context;
    _panel;
    ...
    show() {
        ...
        this._panel = vscode.window.createWebviewPanel("perplexity-settings", "Perplexity AI Settings", vscode.ViewColumn.One, {
            enableScripts: true,
        ...
        this._panel.webview.onDidReceiveMessage(async (message) => {
            switch (message.type) {
                case "saveApiKey":
                    await this._context.secrets.store("perplexity-api-key", message.value);
        ...
        <body>
            ...
            <div class="settings-group">
                ...
                <div class="form-row">
                    ...
                    <input type="number" id="maxTokens" min="1" max="4000" step="1">
...
exports.PerplexitySettingsProvider = PerplexitySettingsProvider;
